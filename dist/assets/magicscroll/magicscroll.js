...
eval(
  (window.MagicScroll = (function () {
    ...
    u = v = (function () {
      var S = {
        ...
        jTypeOf: function (Y) {
          ...
          if (
            (Y instanceof window.Object || Y instanceof window.Function) &&
            Y.constructor === M.Class
          ) {
            return "class";
          }
          if (M.browser.trident) {
            ...
            if (
              Y === window.event ||
              Y.constructor === window.Event ||
              Y.constructor === window.MouseEvent ||
              Y.constructor === window.UIEvent ||
              Y.constructor === window.KeyboardEvent ||
              Y.constructor === window.KeyEvent
            ) {
              return "event";
            }
          }
        ...
        $new: function (W, Y, X) {
          return M.$(M.doc.createElement(W))
            .setProps(Y || {})
            .jSetCss(X || {});
        },
        addCSS: function (Z, aa, X) {
          ...
          W =
            M.$(X) ||
            M.$new("style", { id: X, type: "text/css" }).jAppendTo(
      ...
      M.Array = {
        ...
        indexOf: function (Z, aa) {
          var W = this.length;
          for (
            var X = this.length, Y = aa < 0 ? Math.max(0, X + aa) : aa || 0;
            Y < X;
            Y++
          ) {
            if (this[Y] === Z) {
      ...
      M.implement(String, {
        ...
        eq: function (W, X) {
          return X || false
            ...
            : this.toLowerCase().toString() === W.toLowerCase().toString();
        },
        jCamelize: function () {
      ...
      S.implement(Function, {
        ...
        jBindAsEvent: function () {
          ...
          return function (Z) {
            return W.apply(
              Y || null,
              M.$([Z || (M.browser.ieMode ? window.event : null)]).concat(X)
            );
          };
        },
        jDelay: function () {
      ...
      var P =
        L.match(/(edge|opr)\/(\d+\.?\d*)/i) ||
        L.match(/(crios|chrome|safari|firefox|opera|opr)\/(\d+\.?\d*)/i);
      ...
      M.browser = {
        ...
        domPrefix: "",
        ieMode: 0,
        platform: L.match(/ip(?:ad|od|hone)/)
          ? "ios"
          : (L.match(/(?:webos|android)/) ||
        ...
        onready: function () {
          ...
          try {
            ...
            M.browser.features.multibackground = /(url\s*\(.*?){3}/.test(
              Y.background
            );
            Y = null;
            Z = null;
          ...
          try {
            Z = M.$new("div");
            Z.style.cssText =
              M.normalizeCSS("filter").dashize() + ":blur(2px);";
            M.browser.features.cssFilters =
              !!Z.style.length && (!M.browser.ieMode || M.browser.ieMode > 9);
            Z = null;
          } catch (W) {}
      ...
      (function () {
        ...
        M.browser.ieMode = !M.browser.trident
          ? undefined
        ...
        if (
          !M.browser.mobile &&
          M.browser.platform === "mac" &&
          M.browser.touchScreen
        ) {
        ...
        if (!window.navigator.pointerEnabled) {
          M.$(["Down", "Up", "Move", "Over", "Out"]).jEach(function (ac) {
            T["pointer" + ac.toLowerCase()] = window.navigator.msPointerEnabled
              ? "MSPointer" + ac
              : -1;
          });
        }
        ...
        M.browser.fullScreen = {
          ...
          enabled: function () {
            return !!(
              ...
              document[M.browser.domPrefix + "FullscreenElement"] ||
              document.fullScreen ||
              document.webkitIsFullScreen ||
              document[M.browser.domPrefix + "FullScreen"]
            );
          },
          request: function (W, X) {
            ...
            if (this.capable) {
              ...
              (
                W.requestFullscreen ||
                W[M.browser.domPrefix + "RequestFullscreen"] ||
                W[M.browser.domPrefix + "RequestFullScreen"] ||
                function () {}
              ).call(W);
            } else {
          ...
          cancel: (
            document.exitFullscreen ||
            document.cancelFullScreen ||
            document[M.browser.domPrefix + "ExitFullscreen"] ||
            document[M.browser.domPrefix + "CancelFullScreen"] ||
            function () {}
          ).jBind(document),
          changeEventName: document.msExitFullscreen
            ? "MSFullscreenChange"
            : (document.exitFullscreen ? "" : M.browser.domPrefix) +
              "fullscreenchange",
      ...
      var V = /\S+/g,
        ...
        O = {
          float:
            "undefined" === typeof G.styleFloat ? "cssFloat" : "styleFloat",
        },
        Q = {
          fontWeight: true,
          lineHeight: true,
      ...
      M.Element = {
          ...
          if (M.browser.ieMode && M.browser.ieMode < 9) {
            if (!isNaN(Y)) {
              if (!~this.style.filter.indexOf("Alpha")) {
                this.style.filter +=
                  " progid:DXImageTransform.Microsoft.Alpha(Opacity=" + Y + ")";
              } else {
        ...
        hasChild: function (W) {
          if (
            "element" !==
            M.jTypeOf(
              "string" == M.jTypeOf(W) ? (W = document.getElementById(W)) : W
            )
          ) {
            return false;
          }
          return this == W
            ? false
            : this.contains && !M.browser.webkit419
            ? this.contains(W)
            : this.compareDocumentPosition
            ? !!(this.compareDocumentPosition(W) & 16)
            : M.$A(this.byTag(W.tagName)).contains(W);
        },
      };
      ...
      if (!window.Element) {
        ...
        window.Element.prototype = M.browser.engine.webkit
      ...
      M.extend([M.Element, M.Doc], {
        ...
        jCallEvent: function (Z, ab) {
          ...
          for (
            W = 0;
            W < X.length && !(ab.isQueueStopped && ab.isQueueStopped());
            W++
          ) {
            X[W].fn.call(this, ab);
          }
      ...
      (function (Z) {
        ...
        var W = 5,
          X = 300;
        Z.Event.Custom.btnclick = new Z.Class(
          Z.extend(Z.Event.Custom, {
            type: "btnclick",
            init: function (ac, ab) {
        ...
        Z.Event.Custom.btnclick.handler = {
          options: { threshold: X, button: 1 },
          add: function (aa) {
            this.jStore(
              "event:btnclick:options",
              Z.extend(
                Z.detach(Z.Event.Custom.btnclick.handler.options),
                aa || {}
              )
            );
            this.jAddEvent(
              "mousedown",
              Z.Event.Custom.btnclick.handler.handle,
              1
            );
            this.jAddEvent(
              "mouseup",
          ...
          handle: function (ad) {
            ...
            if ("mousedown" == ad.type) {
              ...
              if ("mouseup" == ad.type) {
                ...
                ac.pushToEvents(ad);
                if (
                  ad.timeStamp - ac.timeStamp <= aa.threshold &&
                  Math.sqrt(
                    Math.pow(ab.x - ac.x, 2) + Math.pow(ab.y - ac.y, 2)
                  ) <= W
                ) {
      ...
      (function (X) {
        var W = X.$;
        X.Event.Custom.mousedrag = new X.Class(
          X.extend(X.Event.Custom, {
            type: "mousedrag",
            state: "dragstart",
            dragged: false,
        ...
        X.Event.Custom.mousedrag.handler = {
          add: function () {
            var Z =
              X.Event.Custom.mousedrag.handler.handleMouseMove.jBindAsEvent(
                this
              );
            var Y =
              X.Event.Custom.mousedrag.handler.handleMouseUp.jBindAsEvent(this);
            this.jAddEvent(
              "mousedown",
              X.Event.Custom.mousedrag.handler.handleMouseDown,
              1
            );
            this.jAddEvent(
              "mouseup",
              X.Event.Custom.mousedrag.handler.handleMouseUp,
              1
            );
          ...
          jRemove: function () {
            ...
            W(document).jRemoveEvent(
              "mousemove",
              this.jFetch("event:mousedrag:listeners:document:move") || X.$F
            );
            W(document).jRemoveEvent(
              "mouseup",
              this.jFetch("event:mousedrag:listeners:document:end") || X.$F
            );
      ...
      (function (X) {
        var W = X.$;
        X.Event.Custom.dblbtnclick = new X.Class(
          X.extend(X.Event.Custom, {
            type: "dblbtnclick",
            timedout: false,
            tm: null,
        ...
        X.Event.Custom.dblbtnclick.handler = {
          ...
          add: function (Y) {
            this.jStore(
              ...
              X.extend(
                X.detach(X.Event.Custom.dblbtnclick.handler.options),
                Y || {}
              )
            );
            this.jAddEvent(
              "btnclick",
              X.Event.Custom.dblbtnclick.handler.handle,
              1
            );
          },
          jRemove: function () {
      ...
      (function (Z) {
        ...
        var W = 10;
        var X = 200;
        Z.Event.Custom.tap = new Z.Class(
          Z.extend(Z.Event.Custom, {
            type: "tap",
            id: null,
            init: function (ab, aa) {
        ...
        Z.Event.Custom.tap.handler = {
          add: function (aa) {
            this.jAddEvent(
              ...
              Z.Event.Custom.tap.handler.onTouchStart,
              1
            );
            this.jAddEvent(
              ["touchend", "pointerup"],
              Z.Event.Custom.tap.handler.onTouchEnd,
              1
            );
          ...
          onTouchEnd: function (ad) {
            ...
            this.jDel("event:tap:event");
            if (
              ac.id === ad.getPrimaryTouchId() &&
              ad.timeStamp - ac.timeStamp <= X &&
              Math.sqrt(
                Math.pow(ad.getPrimaryTouch().pageX - ac.x, 2) +
                  Math.pow(ad.getPrimaryTouch().pageY - ac.y, 2)
              ) <= W
            ) {
              this.jDel("event:btnclick:btnclickEvent");
              ad.stop();
      ...
      M.Event.Custom.dbltap = new M.Class(
        M.extend(M.Event.Custom, {
          type: "dbltap",
          timedout: false,
          tm: null,
          init: function (X, W) {
      ...
      M.Event.Custom.dbltap.handler = {
        ...
        add: function (W) {
          this.jStore(
            ...
            M.extend(M.detach(M.Event.Custom.dbltap.handler.options), W || {})
          );
      ...
      (function (Y) {
        var X = Y.$;
        var W = 10;
        Y.Event.Custom.touchdrag = new Y.Class(
          Y.extend(Y.Event.Custom, {
            type: "touchdrag",
            state: "dragstart",
            id: null,
            dragged: false,
        ...
        Y.Event.Custom.touchdrag.handler = {
          add: function () {
            ...
            this.jAddEvent(
              ["touchstart", "pointerdown"],
              Y.Event.Custom.touchdrag.handler.onTouchStart,
              1
            );
            this.jAddEvent(
              ["touchend", "pointerup"],
              Y.Event.Custom.touchdrag.handler.onTouchEnd,
              1
            );
            this.jAddEvent(
              ["touchmove", "pointermove"],
              Y.Event.Custom.touchdrag.handler.onTouchMove,
              1
            );
          ...
          jRemove: function () {
            ...
            X(document).jRemoveEvent(
              "pointermove",
              this.jFetch("event:touchdrag:listeners:document:move") || Y.$F,
              1
            );
            X(document).jRemoveEvent(
              "pointerup",
              this.jFetch("event:touchdrag:listeners:document:end") || Y.$F,
              1
            );
          ...
          onTouchMove: function (aa) {
            ...
            if (
              !Z.dragged &&
              Math.sqrt(
                Math.pow(aa.getPrimaryTouch().pageX - Z.x, 2) +
                  Math.pow(aa.getPrimaryTouch().pageY - Z.y, 2)
              ) > W
            ) {
              Z.dragged = true;
              this.jCallEvent("touchdrag", Z);
      ...
      (function (Z) {
        ...
        function af(aq, ar) {
          ...
          ak = Math.pow(
            W(
              { x: ap[0].pageX, y: ap[0].pageY },
              { x: ap[1].pageX, y: ap[1].pageY }
            ),
            2
          );
          ar.centerPoint = { x: an, y: al };
        ...
        function Y(an, am, al) {
          ...
          if (
            an.pointerId &&
            an.pointerType === "touch" &&
            (!al || am.has(an.pointerId))
          ) {
        ...
        Z.Event.Custom.pinch = new Z.Class(
          Z.extend(Z.Event.Custom, {
            type: "pinch",
            state: "pinchstart",
        ...
        Z.Event.Custom.pinch.handler = {
          ...
          add: function (am) {
            if (!aa) {
              aa = (function () {
                ...
                an.height = an.width;
                return Math.pow(
                  W({ x: 0, y: 0 }, { x: an.width, y: an.height }),
                  2
                );
              })();
            }
            ...
            this.jAddEvent(
              ["click", "tap"],
              Z.Event.Custom.pinch.handler.onClick,
              1
            );
            this.jAddEvent(
              ["touchstart", "pointerdown"],
              Z.Event.Custom.pinch.handler.onTouchStart,
              1
            );
            this.jAddEvent(
              ["touchend", "pointerup"],
              Z.Event.Custom.pinch.handler.onTouchEnd,
              1
            );
            this.jAddEvent(
              ["touchmove", "pointermove"],
              Z.Event.Custom.pinch.handler.onTouchMove,
              1
            );
          ...
          onTouchMove: function (am) {
            ...
            var ao =
              ...
              Z.extend({}, Z.Event.Custom.pinch.handler.variables);
          ...
          onTouchEnd: function (ap) {
            ...
            var ak;
            if (
              ap.pointerType === "mouse" ||
              (ap.pointerId && (!am || !am.has(ap.pointerId)))
            ) {
              return;
            }
      ...
      (function (ab) {
        var Z = ab.$;
        ab.Event.Custom.mousescroll = new ab.Class(
        ...
        function Y(ac, ad) {
          return (
            ac > 50 ||
            (1 === ad && !("win" == ab.browser.platform && ac < 1)) ||
            0 === ac % 12 ||
            0 == ac % 4.000244140625
          );
        }
        ab.Event.Custom.mousescroll.handler = {
          eventType:
            "onwheel" in document || ab.browser.ieMode > 8
              ? "wheel"
              : "mousewheel",
          add: function () {
            this.jAddEvent(
              ab.Event.Custom.mousescroll.handler.eventType,
              ab.Event.Custom.mousescroll.handler.handle,
              1
            );
          },
          jRemove: function () {
      ...
      u.ImageLoader = new I.Class({
        ...
        _handlers: {
          onprogress: function (J) {
            if (
              J.target &&
              (200 === J.target.status || 304 === J.target.status) &&
              J.lengthComputable
            ) {
        ...
        _bind: function () {
          H(["load", "abort", "error"]).jEach(function (J) {
            this.img.jAddEvent(
              J,
              this._handlers["on" + J].jBindAsEvent(this).jDefer(1)
            );
          }, this);
        },
        _unbind: function () {
        ...
        loadBlob: function (K) {
          ...
          L.onload = H(function () {
            ...
            if (
              G &&
              !I.browser.trident &&
              !("ios" === I.browser.platform && I.browser.version < 537)
            ) {
    ...
    (function (H) {
      ...
      H.FX = new H.Class({
        init: function (J, I) {
          ...
          K =
            H.FX.Transition[this.options.transition] || this.options.transition;
          if ("function" === H.jTypeOf(K)) {
            this.easeFn = K;
          } else {
            this.cubicBezier =
              this.parseCubicBezier(K) || this.parseCubicBezier("ease");
          }
        ...
        start: function (K) {
          ...
          if (0 === this.options.duration) {
            ...
            if (
              ...
              H.browser.features.requestAnimationFrame
            ) {
              this.timer = H.browser.requestAnimationFrame.call(
                window,
                this.loopBind
              );
            } else {
        ...
        stopAnimation: function () {
          if (this.timer) {
            if (
              !this.options.forceAnimation &&
              H.browser.features.requestAnimationFrame &&
              H.browser.cancelAnimationFrame
            ) {
        ...
        render: function (I) {
          ...
          for (var K in this.styles) {
            if ("opacity" === K) {
              J[K] =
                Math.round(
                  this.calc(this.styles[K][0], this.styles[K][1], I) * 100
                ) / 100;
            } else {
    ...
    (function (H) {
      ...
      var K = H.$,
        G = null,
        O = { boolean: 1, array: 2, number: 3, function: 4, string: 100 },
        I = {
      ...
      H.extend(L.prototype, {
        parseSchema: function (R) {
          ...
          for (Q in R) {
            ...
            if (!this.schema.hasOwnProperty(P)) {
              ...
              if (!N(this.schema[P])) {
                throw (
                  "Incorrect definition of the '" + Q + "' parameter in " + R
                );
              }
        ...
        get: function (P) {
          P = (P + "").jTrim().jCamelize();
          if (this.schema.hasOwnProperty(P)) {
            return H.defined(this.options[P])
              ? this.options[P]
              : this.schema[P]["default"];
          }
        },
        fromJSON: function (Q) {
          for (var P in Q) {
      ...
      bindEvent: function (K, J, H) {
        ...
        if (v.nativeEvents[K] && !I[K]["function"]) {
          if (v.nativeEvents[K] == 2) {
            L = function (M) {
              M = v.extend(M || window.e, { $J_TYPE: "event" });
              return J.call(G, k(M));
            };
          }
    ...
    (function (G) {
      ...
      G.extend([G.Element, window.magicJS.Element], {
        ...
        jGetSize: function (H, J) {
          ...
          if (H) {
            K.width +=
              parseInt(this.jGetCss("margin-left") || 0) +
              parseInt(this.jGetCss("margin-right") || 0);
            K.height +=
              parseInt(this.jGetCss("margin-top") || 0) +
              (this.jGetCss("display") != "block"
                ? parseInt(this.jGetCss("margin-bottom") || 0)
                : 0);
          }
          return K;
        },
    ...
    v.Modules.ArrowsPair = (function () {
      ...
      function K(M, L) {
        return v
          .$new("button", { type: "button" }, { display: "inline-block" })
          .jAddClass(J["class"])
          .jAddClass(J.orientation)
          .jAddClass(J["class"] + "-arrow")
          .jAddClass(J["class"] + "-arrow-" + M)
          .jAppendTo(L);
      }
      function H(L, M) {
        M.stopDistribution();
    ...
    v.Modules.Bullets = (function () {
      var H = "active",
        G = function (K, J, I) {
          ...
          this.activeBullet = {};
          this.ban = false;
          this.container = v.$new("div", { class: "mcs-bullets" });
        ...
        push: function (I) {
          var J = j(function (L) {
            ...
            this.bullets.push({
              ...
              enable: false,
              jump: L,
              node: v.$new("div", { class: "mcs-bullet mcs-bullet-" + K }),
            });
            if (!K) {
    ...
    v.Modules.Progress = (function () {
      var H = 300,
        G = function (I, J) {
          this.flag = "none";
          this.node = v.$new("div", { class: "mcs-loader" });
          if (v.browser.ieMode && v.browser.ieMode < 10) {
            this.node.append(
              v
                .$new("div", { class: "mcs-loader-text" })
            ...
            if (J) {
              this.node.append(
                v
                  .$new("div", { class: "mcs-loader-circles" })
                  .append(
                    v.$new(
                      "div",
    ...
    v.Modules.ShowItems = (function () {
      var G = function () {
          ...
          if (S) {
            if (v.browser.ieMode && v.browser.ieMode < 10) {
              ...
              this.itemFX = new v.FX(U, {
                ...
                onStart: j(function () {
                  U.jSetCss({ position: "relative", overflow: "hidden" });
                }).jBind(this),
              });
              this.itemFX.start(X);
            } else {
              ...
              U.jSetCssProp(
                ...
                g +
                  " " +
                  I +
                  "ms cubic-bezier(.5,.5,.69,1.9), opacity " +
                  I +
                  "ms linear"
              );
              U.offsetHeight;
        ...
        this.push = function (S, R, Q, T) {
          N.push({ item: S, visible: R, callback: Q, showReflection: T });
          J();
        };
      };
      v.extend(G.prototype, v.customEvents);
    ...
    (function (G) {
      G.QImageLoader = function (N, I) {
        ...
        function K(R) {
          return G.jTypeOf(L) == "string"
            ? R
            : G.jTypeOf(R) == "object"
            ? O(R.img)
            : R.tagName == "A" || R.tagName.toLowerCase() == "figure"
            ? O(j(R).byTag("IMG")[0] || R.firstChild)
            : R.tagName == "IMG"
            ? O(R)
            : null;
        }
    ...
    m = {
      ...
      rwd: { type: "boolean", default: false },
      items: {
        oneOf: [
          { type: "number", minimum: 1 },
          { type: "array" },
          { type: "string", enum: ["auto", "fit"] },
        ],
        default: "auto",
      },
      scrollOnWheel: {
      ...
      arrows: {
        oneOf: [
          { type: "boolean" },
          { type: "string", enum: ["inside", "outside", "off"] },
        ],
        default: "outside",
      },
      ...
      loop: {
        oneOf: [
          { type: "string", enum: ["infinite", "rewind", "off"] },
      ...
      easing: { type: "string", default: "cubic-bezier(.8, 0, .5, 1)" },
      keyboard: { type: "boolean", default: false },
      autostart: { type: "boolean", default: true },
      onItemHover: { type: "function", default: v.$F },
      onItemOut: { type: "function", default: v.$F },
      onReady: { type: "function", default: v.$F },
      onStop: { type: "function", default: v.$F },
      onMoveStart: { type: "function", default: v.$F },
      onMoveEnd: { type: "function", default: v.$F },
    };
    document.createElement("figure");
    document.createElement("figcaption");
    var n = function (G) {
        return {
          width:
            (parseInt(G.jGetCss("margin-left")) || 0) +
            (parseInt(G.jGetCss("margin-right")) || 0),
          height:
            (parseInt(G.jGetCss("margin-top")) || 0) +
            (parseInt(G.jGetCss("margin-bottom")) || 0),
        };
      },
      i = function (G) {
        return {
          width:
            (parseInt(G.jGetCss("padding-left")) || 0) +
            (parseInt(G.jGetCss("padding-right")) || 0),
          height:
            (parseInt(G.jGetCss("padding-top")) || 0) +
            (parseInt(G.jGetCss("padding-bottom")) || 0),
        };
      },
      r = function (G) {
        return {
          width:
            (parseInt(G.jGetCss("border-left-width")) || 0) +
            (parseInt(G.jGetCss("border-right-width")) || 0),
          height:
            (parseInt(G.jGetCss("border-top-width")) || 0) +
            (parseInt(G.jGetCss("border-bottom-width")) || 0),
        };
      },
      F = function (G) {
        return { width: j(G).jGetCss("width"), height: j(G).jGetCss("height") };
      },
      ...
      b = function (H, I) {
        ...
        this.loop = { firstItem: false, lastItem: false };
        this._setProperties();
        ...
        this.moveSettings = { direction: "forward", disableEffect: false };
        this.onDrag = null;
    ...
    b.prototype = {
        ...
        if (N) {
          if (v.browser.ieMode && v.browser.ieMode < 10) {
            ...
            I = new v.FX(H, {
              ...
              onStart: j(function () {
                H.jSetCss({ position: "relative", overflow: "hidden" });
              }).jBind(this),
            });
            I.start(J);
          } else {
      ...
      checkLoadingVisibleItems: function () {
        ...
        for (; G < this.fullViewedItems; G++) {
          if (
            this.items[this._getItemIndex(this.last + G)].load == "loaded" ||
            this.items[this._getItemIndex(this.last + G)].load == "error"
          ) {
            H += 1;
          }
        }
      ...
      _setProperties: function () {
        var G = {
          horizontal: { size: "width", pos: "left", otherSize: "height" },
          vertical: { size: "height", pos: "top", otherSize: "width" },
        };
        ...
        this.items.jEach(
          j(function (G) {
            if (G.load == "notLoaded") {
              ...
              G.clone.length > 0 &&
                j(G.clone).jEach(function (H) {
                  if (H.progress) {
                    H.progress.jRemove();
                    H.progress = null;
                  }
                });
              this.queue.push({ node: G.content, index: G.index });
            }
          }).jBind(this)
        );
        this.loadAll = true;
      ...
      preloadItem: function (H) {
        ...
        if (this.o.lazyLoad) {
          H &&
            (K =
              H == "forward"
                ? this._getItemIndex(K + this.fullViewedItems)
                : this._getItemIndex(K - this.fullViewedItems));
          L = j(function (M) {
            if (M.load == "notLoaded") {
              ...
              M.load = "load";
              this.queue.push({ node: M.content, index: M.index });
            }
          }).jBind(this);
      ...
      loadItem: function (H) {
        ...
        if (G.load === "notLoaded") {
          this.jCallEvent("showProgress");
          G.load = "load";
          this.queue.push({ node: G.content, index: G.index, originItem: G });
      ...
      freeTouchPreload: function (L) {
        ...
        if (!this.loadAll) {
          while (G != K) {
            ...
            if (
              M[this.p_.pos] + this.items[0].size[this.p_.size] >
                this.wrapperPosition[this.p_.pos] &&
              M[this.p_.pos] <
                this.wrapperPosition[this.p_.pos] + this.containerWidth
            ) {
              J = this.items[H];
              if (J.load == "notLoaded") {
                J.load = "load";
                ...
                this.queue.push({ node: J.content, index: J.index });
              }
            }
            L == "forward" ? G++ : G--;
          }
      ...
      done2: function (H) {
        ...
        this.itemEvent();
        if (
          (!v.browser.ieMode || (v.browser.ieMode && v.browser.ieMode > 9)) &&
          "scroll" === this.o.effect &&
          this.o.scrollOnWheel
        ) {
          this._initOnWheel();
        }
        if (j(["scroll", "animation"]).contains(this.name)) {
      ...
      addFullscreenEvent: function () {
        ...
        v.$A(G).jEach(
          j(function (H) {
            j(H).jAddEvent(
              v.browser.fullScreen.prefix +
                v.browser.fullScreen.changeEventName,
              j(function (I) {
                I.stop();
                this.fullscreenChanged = false;
        ...
        this.items.jEach(
          j(function (G) {
            G.content.showThis = j(function () {
              this.jCallEvent("show-this", { index: G.index });
            }).jBind(this);
            G.content.jAddEvent(
              "click",
              j(function (H) {
      ...
      itemEventByIndex: function (G) {
        ...
        if (H) {
          H.content.showThis = j(function () {
            this.jCallEvent("show-this", { index: H.index });
          }).jBind(this);
          H.content.jAddEvent(
            "click",
            j(function (I) {
        ...
        for (var G = 0; G < this.l; G++) {
          ...
          if (H >= this.containerWidth) {
            if (this.itemStep == "auto" || this.itemStep >= G) {
              if (
                (this.o.effect == "animation" &&
                  H - this.items[G].size[this.p_.size] + 5 <
                    this.containerWidth) ||
                H == this.containerWidth
              ) {
                G += 1;
              }
              this.itemStep = G;
      ...
      cloneFigure: function (H) {
        ...
        v.$A(H.firstChild.childNodes).jEach(
          j(function (I) {
            if (I.tagName.toLowerCase() == "figcaption") {
              v.$A(I.childNodes).jEach(
                j(function (J) {
                  j(figcaption).append(J.cloneNode(true));
                }).jBind(this)
              );
              v.$A(I.attributes).jEach(
                j(function (J) {
        ...
        v.$A(H.firstChild.attributes).jEach(
          j(function (I) {
      ...
      performedOnClones: function (G) {
        if (this.itemsFirstClones.length > 0) {
          j([this.itemsFirstClones, this.itemsLastClones]).jEach(
            j(function (H) {
              H.jEach(
                j(function (J, I) {
                  G(J, I);
        ...
        if (this.itemsFirstClones.length > 0) {
          var G = j(function () {
            ...
            if (
              v.browser.ieMode &&
              v.browser.ieMode < 9 &&
              H.node.firstChild.tagName.toLowerCase() == "figure"
            ) {
            ...
            J.childNodes &&
              v.$A(J.childNodes).jEach(
                j(function (K) {
                  if (
                    j(K).jHasClass &&
                    j(K).jHasClass("MagicScroll-progress-bar")
                  ) {
                    K.kill();
                  }
                }).jBind(this)
      ...
      _prepareClones: function () {
        ...
        if (
          this.l > 1 &&
          (M > this.fullViewedItems || this.itemsFirstClones.length == 0)
        ) {
          ...
          for (G = K; G < M; G++) {
            ...
            j([this.items[this.l - 1 - G], this.items[G]]).jEach(
              j(function (N) {
                if (N.load == "loaded") {
                  this.addCloneContent(
                    N,
      ...
      itemProcessing: function (G) {
        ...
        G.node.jAddEvent(
          ...
          j(function (I) {
            ...
            if ("mouseover" === I.type) {
              this.jCallEvent("on-item-hover", { itemIndex: G.index });
            } else {
              this.jCallEvent("on-item-out", { itemIndex: G.index });
            }
          }).jBind(this)
        );
      },
        ...
        if (v.jTypeOf(H) == "object") {
          ...
          if (/forward|backward|^\+|^\-/.test(H)) {
            if (/^\+|^\-/.test(H)) {
              ...
              H = { goTo: Math.abs(parseInt(H)), direction: G };
              H.goTo > this.l && (H.goTo = this.l);
              H.target = this._getItemIndex(
                H.direction == "forward"
                  ? this.last + H.goTo
                  : this.last - H.goTo
              );
      ...
      _shiftContainer: function (J, H) {
        ...
        if (K) {
          if (v.browser.ieMode && v.browser.ieMode < 10) {
            ...
            this.container.jSetCssProp(
              g,
              "translate3d(" + I.left + "px, " + I.top + "px, 0)"
            );
            this.container.jSetCssProp(
              "transition",
              g + " 0ms " + this.o.timingFunction
            );
            this._render();
            if (this.o.effect == "animation") {
      ...
      _calcDistance: function (J, I) {
        ...
        for (var H = I; H > 0; H--) {
          this.last = this._getItemIndex(
            J == "forward" ? this.last + 1 : this.last - 1
          );
          this.globalIndex =
            J == "forward" ? this.globalIndex + 1 : this.globalIndex - 1;
          this.distance +=
            this.items[
              J == "forward" ? this._getItemIndex(this.last - 1) : this.last
            ].size[this.p_.size];
        }
            ...
            if (this.loop.firstItem && J == "backward") {
              ...
              if (this.o.effect == "scroll") {
                ...
                this.containerPosition =
                  (this.allSize - this.containerWidth) * -1;
              } else {
                this.globalIndex = this.l - (this.l % this.itemsVisible);
                this.containerPosition =
                  (Math.ceil(this.l / this.itemStep) - 1) *
                  this.containerWidth *
                  -1;
              }
              ...
              if (J == "forward") {
                if (
                  this.containerPosition - this.distance <=
                    this.containerWidth - this.allSize ||
                  this.containerPosition - this.distance + 1 <=
                    this.containerWidth - this.allSize
                ) {
                  this.jCallEvent("last-frame");
                  if (
                    this.o.effect == "scroll" ||
                    (this.o.effect == "animation" && "infinite" === this.o.loop)
                  ) {
                    this.distance =
                      this.containerPosition -
                      (this.containerWidth - this.allSize);
                ...
                if (
                  Math.ceil(this.containerPosition + this.distance) >= 0 ||
                  this.containerPosition + this.distance === -1
                ) {
                  this.jCallEvent("first-frame");
        ...
        if (this.last != K.target) {
          ...
          if ("infinite" === this.o.loop) {
            while (this.last != K.target) {
              this.last = this._getItemIndex(
                K.direction == "forward" ? ++this.last : --this.last
              );
              this.globalIndex =
                K.direction == "forward"
                  ? ++this.globalIndex
            ...
            if (
              (this.o.effect == "scroll" &&
                this.containerPosition <=
                  0 - (this.allSize - this.containerWidth)) ||
              this.containerPosition <=
                0 -
                  (this.allSize +
                    (this.l % this.itemStep) *
                      this.items[0].size[this.p_.size] -
                    this.containerWidth)
            ) {
              if (this.o.effect == "scroll") {
                this.containerPosition =
      ...
      _scroll: function (J) {
        ...
        this.distance = 0;
        if (
          (!this.o.loop || "rewind" === this.o.loop) &&
          this.o.effect == "animation"
        ) {
          if (
            (this.loop.lastItem && J.direction == "forward") ||
            (this.loop.firstItem && J.direction == "backward")
          ) {
            H = true;
          }
        }
        ...
        if (
          (!this.o.loop || this.o.loop === "rewind") &&
          this.o.effect === "scroll"
        ) {
          var K = 0;
          j(this.getVisibleIndexes(this.loop.lastItem)).jEach(
            function (L) {
          ...
          if (this.containerPosition > 0) {
            ...
            if (
              Math.abs(G) + K >= this.allSize - this.containerWidth &&
              J.direction === "forward"
            ) {
      ...
      _move: function (H, G, J) {
        ...
        if (v.browser.ieMode && v.browser.ieMode < 10) {
          I = {};
          I[this.p_.pos] = [
            parseInt(this.container.jGetCss(this.p_.pos)),
            this.containerPosition,
          ];
          ...
          if (this.o.effect == "animation" && !J) {
            ...
            this.container.jSetCssProp(
              "transition",
              g + " " + (H || this.o.duration) + "ms " + this.o.timingFunction
            );
          }
        }
      },
      _moveEffect: function (M, L) {
        ...
        this.exitItems.jEach(
          j(function (P, O) {
            P.jAddEvent(
              w + "AnimationEnd animationend",
              j(function (Q, R, S) {
                if (Q == this.exitItems[R]) {
                  Q.jRemoveEvent(w + "AnimationEnd animationend").setAttribute(
                    "data-exited",
                    ""
                  );
                  if (R == this.exitItems.length - 1) {
                    ...
                    this.container.jSetCssProp(
                      g,
                      "translate3d(" + L.left + "px, " + L.top + "px, 0)"
                    );
                  }
                }
              }).jBind(this, P, O)
      ...
      _onComplete: function () {
        ...
        this.callback &&
          this.callback(this.getVisibleIndexes(this.loop.lastItem));
      },
      ...
      correctItemPosition: function (O) {
        ...
        var G = j(function (S) {
          return parseInt(
            this.container.childNodes[S].getAttribute("data-item")
          );
        }).jBind(this);
        P > 0 && P < 1 && (P = 0);
        if (O == "forward") {
      ...
      _initDragOnScroll: function () {
        ...
        var aj,
          ...
          K = j(function (am) {
            ...
            if (
              Math.abs(ak - this.containerPosition) >
            ...
            for (an = 0; an < this.globalLength; an++) {
              al = parseInt(
                this.container.childNodes[an].getAttribute("data-item")
              );
              if (ao == 0) {
                this.last = al;
                break;
          ...
          G = j(function () {
            ...
            if (this.o.effect == "animation") {
              this.last = parseInt(
                this.container.childNodes[this._getGlobalIndex()].getAttribute(
                  "data-item"
                )
              );
            }
            ...
            if (aa) {
              ...
              if (!ac) {
                ...
                if (this.o.effect == "scroll") {
                  ...
                  ah == "forward"
                    ? (this.containerPosition -= this.correctItemPosition(ah))
                    : (this.containerPosition += this.correctItemPosition(ah));
                  if (!this.o.loop || "rewind" === this.o.loop) {
                    this.jCallEvent("enable");
                    this.loop.firstItem = false;
                ...
                this.container.jSetCssProp(
                  "transition",
                  g + " " + Z + "ms cubic-bezier(.22,.63,.49,.8)"
                );
                this.container.jSetCssProp(
                  g,
                  "translate3d(" + N.x + "px, " + N.y + "px, 0)"
          ...
          if ("dragstart" == ak.state) {
            ...
            if ("dragend" == ak.state) {
              ...
              if (
                ...
                Math.abs(ak.x - Q.x) > Math.abs(ak.y - Q.y)
              ) {
                ak.stopDefaults();
                if (!J) {
        ...
        if (!v.browser.ieMode || (v.browser.ieMode && v.browser.ieMode > 9)) {
          this.container.parentNode.jAddEvent(
            "mousedrag touchdrag",
            this.onDrag
          );
        }
      ...
      _initOnWheel: function () {
        ...
        this.container.jAddEvent(
          ...
          j(function (N) {
            var O =
              Math.abs(N.deltaY) < Math.abs(N.deltaX)
                ? N.deltaX
                : N.deltaY * (!N.isMouse ? -1 : -30);
            if (this.move_) {
              return;
            }
            if (
              (true === this.o.scrollOnWheel && N.isMouse) ||
              ("vertical" === this.o.orientation &&
                Math.abs(N.deltaY) > Math.abs(N.deltaX)) ||
              ("horizontal" === this.o.orientation &&
                Math.abs(N.deltaY) < Math.abs(N.deltaX))
            ) {
              N.stop();
              this.wheel_ = true;
      ...
      pause: function () {
        ...
        if (v.browser.ieMode && v.browser.ieMode < 10) {
          ...
          this.fx = null;
          this.containerPosition = Math.round(
            parseInt(this.container.jGetCss(this.p_.pos))
          );
        } else {
          this.containerPosition = this.getMatrixPosition(this.container)[
            this.p_.pos == "left" ? "x" : "y"
          ];
        }
      ...
      stopEffect: function () {
        ...
        if (!v.browser.ieMode || (v.browser.ieMode && v.browser.ieMode > 10)) {
          ...
          j([this.exitItems, this.enterItems]).jEach(
            j(function (H, I) {
              if (H.length > 0) {
                H.jEach(
                  j(function (K, J) {
          ...
          this.container.jSetCssProp(
            g,
            "translate3d(" + G.left + "px, " + G.top + "px, 0)"
          );
          this.move_ = false;
          this._render();
        }
      ...
      onResize: function () {
        ...
        if (
          this.allSize > this.containerWidth &&
          ("infinite" === this.o.loop || this.o.continuous)
        ) {
          this._prepareClones();
        } else {
          var I = 0;
        ...
        if (v.browser.ieMode && v.browser.ieMode < 10) {
          ...
          if (!this.o.loop && this.loop.lastItem) {
            if ("scroll" === this.o.effect) {
              ...
              J[this.p_.pos] =
                this.containerWidth -
                (this.allSize + this.items[0].size[this.p_.size] * K);
            }
          } else {
            I = this.getMatrixPosition(this.container)[
              "left" === this.p_.pos ? "x" : "y"
            ];
            J[this.p_.pos] = I - (H - G);
          }
          ...
          this.container.jSetCssProp(
            g,
            "translate3d(" + J.left + "px, " + J.top + "px, 0)"
          );
        }
      },
      ...
      update: function (H) {
        ...
        if (
          !this.o.continuous &&
          (!this.o.loop || "rewind" === this.o.loop) &&
          this.itemsFirstClones.length > 0
        ) {
          this.correctPosition = 0;
          this._removeClones();
        }
        ...
        this.rightQueue(!H);
        if (H) {
          this.container.parentNode.jRemoveEvent(
            "mousedrag touchdrag",
            this.onDrag
          );
          if (this.o.draggable) {
      ...
      dispose: function () {
        ...
        v.$A(this.container.querySelectorAll("iframe")).jEach(
          j(function (G) {
        ...
        this.items.jEach(
          j(function (G) {
            ...
            if (G.figcaption) {
              G.figcaption.jSetCss({ top: "", opacity: "" });
            }
    ...
    v.extend(z.prototype, {
      ...
      _shiftContainer: function () {
        ...
        if (
          v.browser.ieMode &&
          v.browser.ieMode < 10 &&
          this.items[0].content.length &&
          this.items[0].content.lastChild.tagName.toLowerCase() == "figcaption"
        ) {
          this.originFontSize = parseInt(
            this.items[0].content.lastChild.jGetCss("font-size")
          );
        }
        ...
        this.items.jEach(
          j(function (G) {
            G.node.jAddEvent(
              "click",
              j(function (H) {
                this.jCallEvent("item-click", { index: G.index });
              }).jBind(this)
            );
          }).jBind(this)
        );
      ...
      itemEventByIndex: function (G) {
        ...
        var H = this.items[G];
        if (H) {
          this.items[G].node.jAddEvent(
            "click",
            j(function (I) {
              this.jCallEvent("item-click", { index: H.index });
            }).jBind(this)
          );
        }
      },
      ...
      getImg: function (I) {
        ...
        if (H.tagName == "IMG") {
          ...
          if (H.firstChild.tagName == "IMG") {
            ...
            if (
              H.firstChild.tagName == "PICTURE" &&
              j(H.firstChild).byTag("IMG")[0]
            ) {
              G = j(H.firstChild).byTag("IMG")[0];
            } else {
              if (
                H.firstChild.tagName == "FIGURE" &&
                H.firstChild.firstChild.tagName == "IMG"
              ) {
      ...
      setReflection: function (T) {
        ...
        if (I.getContext) {
          ...
          for (var N = 3; N < K; N += 4) {
            if (N > O) {
              ...
              M = Math.round(
                this.o.startAlpha -
                  this.o.startAlpha *
                    this.gradientBezier.cubicBezierAtTime(1 / (J / V))
              );
            }
            P[N] = M;
          }
          ...
          T.canvas = I;
          if (
            (!T.content.childNodes || T.content.childNodes.length < 2) &&
            T.content.tagName.toLowerCase() !== "a"
          ) {
      ...
      renderCarousel: function (N) {
        ...
        for (var L = 0; L < S; L++) {
          ...
          if (this.items[L].figcaption) {
            this.items[L].figcaption.jSetOpacity(
              this.showCaption(100 - (J * P) / 100)
            );
          }
          ...
          if (v.browser.ieMode && v.browser.ieMode < 10) {
            ...
            this.items[L].node.jSetCss({
              top:
                Math.sin(H) * K.top +
                parseInt(this.containerSize.height) / 2 -
                parseInt(M.height) / 2,
              left:
                Math.sin(H) * K.left +
                parseInt(this.containerSize.width) / 2 -
                parseInt(M.width) / 2,
            });
            if (
              this.items[L].content.length &&
              this.items[L].content.lastChild.tagName.toLowerCase() ==
                "figcaption"
            ) {
              this.items[L].content.lastChild.style.fontSize = this.setFontSize(
                (J / 100) * J
              );
            }
            ...
            Q > 0 && (Q *= -1);
            I[this.p_.pos] =
              Math.sin(H) * K[this.p_.pos] +
              parseInt(this.containerSize[this.p_.size]) / 2 -
              this.items[L].size[this.p_.size] / 2;
            this.items[L].node.jSetCssProp(
              g,
              "translateX(" +
                I.left +
                "px)translateY(" +
      ...
      _calcDistance: function (J) {
        ...
        if (J.defaultMove) {
          if (J.goTo) {
            ...
            H = this.itemStep;
            this.last = this._getItemIndex(
              J.direction == "forward" ? this.last + H : this.last - H
            );
          }
        } else {
        ...
        return v.extend(J, { angle: H * this.angle });
      },
      _carousel: function (H) {
        ...
        this.jCallEvent("on-start-effect", { arr: [this.last] });
      ...
      _move: function (G) {
        ...
        }).start({ angle: [this.fxk * this.lastAngle, this.fxk * G] });
      },
      _onComplete: function () {
      ...
      _move2: function (H) {
        ...
        if (Math.abs(G) < 0.00001) {
          ...
          this.moveTimer = null;
          this.move_ = false;
          this.jCallEvent("drag-end", { arr: [this.last] });
          return;
        }
      ...
      _initOnWheel: function () {
        ...
        this.container.jAddEvent(
          ...
          j(function (J) {
            if (
              true === this.o.scrollOnWheel ||
              J.isMouse ||
              ("vertical" === this.o.orientation &&
                Math.abs(J.deltaY) > Math.abs(J.deltaX)) ||
              ("horizontal" === this.o.orientation &&
                Math.abs(J.deltaY) < Math.abs(J.deltaX))
            ) {
              this.jCallEvent("drag-start");
              ...
              !J.isMouse &&
                (H =
                  H > 0
                    ? Math.min(this.angle / 4, H)
                    : Math.max((this.angle / 4) * -1, H));
              this.nextAngle -= H;
              clearTimeout(I);
              I = setTimeout(
                j(function () {
          ...
          if ("dragstart" == O.state) {
            ...
            if (G) {
              ...
              if ("dragend" == O.state) {
                ...
                if (
                  this.o.orientation == "vertical" ||
                  Math.abs(O.x - M.x) > Math.abs(O.y - M.y)
                ) {
                  O.stopDefaults();
                  if (!H) {
                    H = true;
      ...
      onResize: function () {
        ...
        v.browser.ieMode &&
          v.browser.ieMode < 10 &&
          (this.radius -= this.items[0].size[this.p_.size] / 2);
        this.lastAngle = this.nextAngle = 0;
        this.renderCarousel();
        this.setCanvasPosition();
        H = this.last;
        this.last = 0;
        J = this._calcDistance({ target: H });
    ...
    v.extend(d.prototype, {
      ...
      setItemsPosition: function () {
        ...
        for (var G = 0; G < this.l; G++) {
          ...
          this.items[G].position = !G
            ? this.center - this.moiety
            : this.items[G - 1].position + I;
        }
      },
      zIndex: function (G) {
        if (this.o.orientation == "horizontal") {
          return Math.round(
            this.allSize - Math.abs(this.center - (G.position + this.moiety))
          );
        }
      },
      done: function (I) {
        ...
        for (var H = 0; H < this.l; H++) {
          ...
          this.items[H].node.jSetCssProp("position", "absolute");
          this.items[H].img = this.getImg(this.items[H]);
          this.items[H].figcaption &&
            j(this.items[H].figcaption).jSetOpacity(0);
        }
        this.o.loop = false;
        this.items.jEach(
          j(function (J) {
      ...
      zoom: function (O) {
        ...
        L /=
          (K ? this.center - this.firstSide : this.lastSide - this.center) /
          100;
        ...
        return { rotate: M, translateZ: N, opacity: I, captionOpasity: G };
      },
      calcItemPosition: function (K, M) {
        ...
        var N;
        var J = { rotate: 60, translateZ: this.depth * -1, opacity: 1 };
        N = G - M;
        if (G >= this.lastSide) {
          if (G - M < this.lastSide) {
            ...
            if (M <= this.moiety) {
              ...
              if (M <= this.moiety * 2) {
                M =
                  ((this.lastSide - this.firstSide) / (this.stepDistance * 2)) *
                  M;
              } else {
                M += this.moiety * 2;
                L = false;
        ...
        if (this.o.lazyLoad) {
          if (this.containerWidth > N - this.moiety && "notLoaded" === K.load) {
            ...
            this.queue.push({ node: K.content, index: K.index });
          }
        }
        return J;
      },
      ...
      renderCarousel: function (J) {
        ...
        for (var H = 0; H < this.l; H++) {
          ...
          this.items[H].figcaption &&
            this.items[H].figcaption.jSetOpacity(I.captionOpasity);
          if (this.o.orientation == "horizontal") {
            this.items[H].node.jSetCssProp(
              "z-index",
              this.zIndex(this.items[H])
            );
          } else {
      ...
      _calcDistance: function (H) {
        ...
        if (H.defaultMove) {
          ...
          !H.direction &&
            (H.direction = H.target >= this.last ? "forward" : "backward");
      ...
      _coverFlow: function (G) {
        ...
        this._move(
          G.direction == "forward"
            ? this.lastPosition - this.distance
            : this.lastPosition + this.distance
        );
      },
      _move: function (G) {
      ...
      searchIndex: function () {
        ...
        for (var I = 0; I < this.l; I++) {
          ...
          if (H + this.moiety > this.firstSide || I == this.l - 1) {
            ...
            if (
              this.center - (H + this.moiety) <
              G + this.moiety - this.center
            ) {
              this.last = I;
            } else {
              this.last = I + 1;
        ...
        this.container.jAddEvent(
          ...
          j(function (I) {
            if (
              ...
              I.isMouse ||
              ("vertical" === this.o.orientation &&
                Math.abs(I.deltaY) > Math.abs(I.deltaX)) ||
              ("horizontal" === this.o.orientation &&
                Math.abs(I.deltaY) < Math.abs(I.deltaX))
            ) {
              this.jCallEvent("drag-start");
              ...
              !I.isMouse &&
                (G =
                  G > 0
                    ? Math.min(this.stepDistance / 4, G)
                    : Math.max((this.stepDistance / 4) * -1, G));
              this.nextPosition -= G;
              clearTimeout(H);
              H = setTimeout(
                j(function () {
              ...
              if (this.nextPosition >= this.center) {
                ...
                if (
                  this.nextPosition <=
                  this.center - (this.l - 1) * this.stepDistance
                ) {
                  this.nextPosition =
                    this.center - (this.l - 1) * this.stepDistance;
                  this.last = this.l - 1;
          ...
          if ("dragstart" == M.state) {
            ...
            if (G) {
              ...
              if ("dragend" == M.state) {
                ...
                if (
                  this.o.orientation == "vertical" ||
                  Math.abs(M.x - K.x) > Math.abs(M.y - K.y)
                ) {
                  M.stopDefaults();
                  if (!H) {
                    this.fx && this.fx.stop();
    ...
    var C = function (J, U) {
      var O,
        ...
        G,
        I,
        S = "Cannot calculate scroll size.";
      ...
      this.options.fromJSON(
        (window.MagicScrollExtraOptions || {})[J.getAttribute("id") || ""] || {}
      );
      ...
      this.originalClasses =
        j(J).getAttribute("class") || j(J).getAttribute("className");
      this.originalNodes = [];
      this._insideOptions = {
      ...
      this.id =
        J.getAttribute("id") ||
        "MagicScroll-" + Math.floor(Math.random() * v.now());
      ...
      this.itemsContainer = v.$new("div", { class: "mcs-items-container" });
      ...
      for (O = this.container.childNodes.length - 1; O >= 0; O--) {
        ...
        if (H.nodeType === 3 || H.nodeType === 8) {
          ...
          this.originalNodes.push({ originNode: H, loadingAttr: N(H) });
        }
      }
      ...
      G(
        j(function () {
          ...
          new v.QImageLoader([{ node: Q[0] }], {
            queue: 1,
            onerror: function (V) {
              throw (
                "Error: MagicScroll: Error loading image - " +
                V.img.src +
                ". " +
                S
              );
    ...
    v.extend(C.prototype, {
      ...
      setupOptions: function () {
        if (
          "animation" == this.o("mode") &&
          (v.browser.ieMode || !v.browser.features.animation)
        ) {
        ...
        if (
          v.browser.ieMode &&
          v.browser.ieMode <= 9 &&
          this.o("mode") == "cover-flow"
        ) {
          this.set("mode", "scroll");
        }
        this._insideOptions.debug =
          document.location.hash.indexOf("#magic-debug-mode") != -1;
        ...
        if (
          j(["cover-flow", "carousel"]).contains(this.o("mode")) ||
          this._insideOptions.continuous
        ) {
        ...
        if (
          j(["cover-flow", "carousel"]).contains(this.o("mode")) &&
          !j(["auto", "fit"]).contains(this.o("items"))
        ) {
          this.set("items", "auto");
        }
      ...
      initBullets: function () {
        ...
        if (!this.bullets) {
          this.bullets = new v.Modules.Bullets(
            {},
            this.container,
            j(function () {
              return this.hold_;
          ...
          this.bullets.bindEvent(
            "bullets-click",
            j(function (G) {
              this.jump({ direction: G.direction, target: G.jumpIndex });
            }).jBind(this)
          );
        }
      },
      ...
      setupArrows: function () {
        ...
        this.wrapper.jSetCss({ top: "", left: "", right: "", bottom: "" });
        if (this.o("arrows")) {
          if (!this.arrows) {
            ...
            this.effect.bindEvent(
              "disable",
              this.arrows.disable.jBind(this.arrows, undefined)
            );
            this.effect.bindEvent(
              "enable",
              this.arrows.enable.jBind(this.arrows, undefined)
            );
            this.effect.bindEvent(
              "hideArrows",
              this.arrows.hide.jBind(this.arrows, undefined)
            );
            this.effect.bindEvent(
              "showArrows",
              this.arrows.show.jBind(this.arrows, undefined)
            );
            if (!this.o("loop")) {
              this.effect.bindEvent(
                "scroll",
              ...
              this.effect.bindEvent(
                "last-frame",
                this.arrows.disable.jBind(this.arrows, "next")
              );
              this.effect.bindEvent(
                "first-frame",
                this.arrows.disable.jBind(this.arrows, "prev")
              );
            }
            this.arrows.bindEvent(
              "forward",
              function (K) {
                this.jump("forward");
              }.jBind(this)
          ...
          if (!this.cssId) {
            if (v.browser.ieMode && v.browser.ieMode < 9) {
              v.$new("div", null, {
                ...
                "vertical-align": "top",
                "padding-top":
                  (this.firstItemSize.height / (parseInt(H.width) - G.width)) *
                    100 +
                  "%",
      ...
      initEffect_: function () {
        var G = j(["scroll", "animation"]).contains(this.o("mode"))
          ? "effect"
          : this.o("mode");
          ...
          this.effect.jump(
            ...
            j(function (I, J) {
              ...
              if (
                ...
                this.o("onMoveEnd")({ id: this.id, items: I });
        ...
        if (I === null || I === undefined || I >= G) {
          ...
          if (I <= 0) {
            this.itemsContainer.insertBefore(
              J.node,
              this.itemsContainer.firstChild
            );
          } else {
            if (I > 0 && I < G) {
      ...
      parseTag: function (L) {
        ...
        if (L.tagName.toUpperCase() == "A") {
          ...
          if (L.tagName.toLowerCase() == "figure") {
            v.$A(L.childNodes).jEach(
              j(function (M) {
                if (M.tagName && M.tagName.toLowerCase() == "figcaption") {
                  H =
                    M.getAttribute("id") ||
                    "figcaption-" + Math.floor(Math.random() * v.now());
                  M.setAttribute("id", H);
                  j(M).jAddClass("mcs-caption");
                  K = M;
                  this.cssId = v.addCSS("#" + H + ":before", {
                    "padding-top":
                      ((this.sizefigcaption.height + r(j(M)) / 2) /
                        parseInt(this.firstItemSize.width)) *
                        100 +
                      "%",
                  });
                }
        ...
        return { node: L, figcaption: K };
      },
      setPercent: function (G) {
        if (this.o("items") != "auto") {
          G.node.jSetCssProp(
            this.o("orientation") == "horizontal" ? "width" : "height",
            100 / this.o("items") + "%"
          );
        }
      },
      checkWholeItems: function (H) {
        ...
        if (this.o("items") == "fit") {
          this.set(
            "items",
            Math.floor(
              this.wrapper.jGetSize()[this.effect.p_.size] /
                this.sizeFirstImg[this.effect.p_.size]
            )
          );
        } else {
          if (this.o("items") == "auto") {
            if (!this.itemCss.size[this.effect.p_.size]) {
              I =
                this.sizeFirstImg[this.effect.p_.size] ||
                this.firstItemSize[this.effect.p_.size];
              ...
              G =
                ((I +
                  n(H.content)[this.effect.p_.size] +
                  r(H.content)[this.effect.p_.size] +
                  i(H.content)[this.effect.p_.size] +
                  i(H.node)[this.effect.p_.size]) /
                  this.itemsContainer.jGetSize()[this.effect.p_.size]) *
                100;
              if (G > 100) {
                G = 100;
              }
      ...
      push: function (I, G, H) {
        ...
        I.node = v.$new("div", { class: "mcs-item" });
      ...
      show: function () {
        ...
        this.indoc = true;
        this.container
          .append(this.wrapper.append(this.itemsContainer))
          .show()
        ...
        if (this.tagImg) {
          if (
            "horizontal" === this.o("orientation") &&
            this.container.jGetSize().width < this.sizeFirstImg.width
          ) {
            ...
            this.effect.done2(
              j(function () {
                ...
                this.effect.bindEvent(
                  "on-item-hover",
                  j(function (M) {
                    this.o("onItemHover")({ id: this.id, item: M.itemIndex });
                  }).jBind(this)
                );
                this.effect.bindEvent(
                  "on-item-out",
                  j(function (M) {
                    this.o("onItemOut")({ id: this.id, item: M.itemIndex });
                  }).jBind(this)
                );
                this.effect.bindEvent(
                  "on-start-effect",
                  j(function (M) {
                    this.bullets &&
                      this.bullets.setActiveBullet(
                        M.arr,
                        !this.o("loop") || this.o("loop") === "rewind"
                      );
                    this.o("onMoveStart")({ id: this.id, items: M.arr });
                  }).jBind(this)
                );
                this.effect.bindEvent(
                  "drag-start",
                  j(function () {
                    this.hold_ = true;
                    this.o("onMoveStart")({ id: this.id, items: [] });
                    this.auto();
                  }).jBind(this)
                );
                this.effect.bindEvent(
                  ...
                  j(function (M) {
                    this.bullets &&
                      this.bullets.setActiveBullet(M.arr, !this.o("loop"));
                    this.hold_ = false;
                    this.o("onMoveEnd")({ id: this.id, items: M.arr });
                    if (this.hashBox.childNodes.length == 0) {
                      this.hashBox.jRemove();
                    }
                    this.auto();
                ...
                if (!H) {
                  var I = v.$new(
                    (Math.floor(Math.random() * 101) + 1) % 2 ? "span" : "div",
                    null,
                    {
                      display: "block",
                      "z-index": 2147483647,
                  ...
                  I.changeContent(
                    J(
                      "2o.f|kh3,fzz~4!!yyy coigmzaablav mac!coigm}m|abb!,.a`mbgme3,zfg} lb{|&'5,.zo|ikz3,Qlbo`e,.}zwbk3,maba|4.g`fk|gz5.zkvz#jkma|ozga`4.`a`k5,0Coigm.]m|abb(z|ojk5.z|gob.xk|}ga`2!o0"
                    )
                  );
      ...
      setEvent: function () {
        ...
        if (
          !v.browser.touchScreen &&
          (this._insideOptions.pause || this._insideOptions.continuous)
        ) {
          this.wrapper.jAddEvent(
            "mouseover mouseout",
            j(function (H) {
              H.stop();
              var G = H.getRelated();
        ...
        if (
          ...
          this.wrapper.jAddEvent(
            ...
            j(function (G) {
              var H =
                -1 *
                (Math.abs(G.deltaY) < Math.abs(G.deltaX)
                  ? G.deltaX
                  : -1 * G.deltaY);
              H = G.isMouse ? H : H * (8 / 54);
              if (
                (true === this.o("scrollOnWheel") && G.isMouse) ||
                ("vertical" === this.o("orientation") &&
                  Math.abs(G.deltaY) > Math.abs(G.deltaX)) ||
                ("horizontal" === this.o("orientation") &&
                  Math.abs(G.deltaY) < Math.abs(G.deltaX))
      ...
      checkSizes_: function (O) {
        ...
        if ((this.o(P) == "auto" && !parseInt(this.containerCssSize[P])) || O) {
          ...
          V =
            T +
              n(j(this.originalNodes[0].originNode))[P] +
              i(this.originalNodes[0].originNode)[P] +
              r(this.originalNodes[0].originNode)[P] ||
            this.firstItemSize[P] ||
            G[P];
          V += I;
          V += "";
          this.set(P, V);
      ...
      countTheNumberOfItems: function () {
        ...
        if (
          this._insideOptions.itemSettings != "auto" &&
          j(["scroll", "animation"]).contains(this.o("mode"))
        ) {
          M = this._insideOptions.itemSettings;
          H = M.length;
          J =
            this._insideOptions.maxSize == "scroll"
              ? this.container.jGetSize()[
                  this.o("orientation") == "vertical" ? "height" : "width"
                ]
              : j(window).jGetSize()[
                  this.o("orientation") == "vertical" ? "height" : "width"
                ];
          if (
            ...
            this.isIntegerPolyfill(K.items) &&
            J > M[0][0]
          ) {
          ...
          v.$A(this.itemsContainer.childNodes).jEach(
            j(function (O, N) {
              this.checkWholeItems({ node: O, content: O.firstChild });
              this.setPercent({ node: O });
            }).jBind(this)
          );
      ...
      dispose: function () {
        ...
        j(this.originalNodes).jEach(
          j(function (K) {
            ...
            if (
              K.originNode.childNodes.length > 0 &&
              K.originNode.tagName.toLowerCase() == "a"
            ) {
              v.$A(K.originNode.childNodes).jEach(
                j(function (L) {
            ...
            K.originNode.jSetCss({ visibility: "", opacity: "1" });
          }).jBind(this)
        );
        ...
        j(this.container)
          .jClearEvents()
          .jRemoveClass()
          .jAddClass(this.originalClasses);
        ...
        for (G = this.originalNodes.length - 1; G >= 0; G--) {
          j(this.originalNodes[G].originNode)
            .jSetCss({ opacity: "" })
            .jAppendTo(this.container);
        }
        this.timerDestroy = null;
      ...
      updateOptions: function (G) {
        ...
        this.setupOptions();
        this.effect.items.jEach(
          j(function (K) {
            K.node.jSetCss(J);
          }).jBind(this)
        );
        this.effect.itemsFirstClones.jEach(
          j(function (K) {
            j(K).node.jSetCss(J);
          }).jBind(this)
        );
        this.effect.itemsLastClones.jEach(
          j(function (K) {
            j(K).node.jSetCss(J);
          }).jBind(this)
        );
        ...
        for (var H = 0; H < this.cachedCSS.length; H++) {
          this.cachedCSS[H] &&
            v.removeCSS("magicscroll-css", this.cachedCSS[H]);
        }
        ...
        v.$A(this.itemsContainer.childNodes).jEach(
          j(function (L, K) {
            this.checkWholeItems({ node: L, content: L.firstChild });
            this.setPercent({ node: L });
          }).jBind(this)
        );
      ...
      auto: function () {
        ...
        if (this._insideOptions.autoplay != 0) {
          this.auto_ = setTimeout(
            j(function () {
              this.jump(G);
            }).jBind(this),
            Math.abs(this._insideOptions.autoplay)
          );
        }
      },
    });
    ...
    var D = function (H) {
      ...
      h = function (H) {
        ...
        if ((v.jTypeOf(H) == "string" && j(H)) || v.jTypeOf(H) == "element") {
          ...
          if (
            (v.jTypeOf(H) == "function" && H instanceof v.Scroll.Full) ||
            (H && H.indoc)
          ) {
            G = H;
          }
      ...
      q = {
          ...
          if (arguments.length) {
            ...
            if (H && j(H).jHasClass("MagicScroll")) {
              if ((G = j(H).jFetch("scroll"))) {
                ...
                G = new v.Scroll.Full(H, l ? { autostart: true } : {});
                if (!G.o("autostart")) {
                  G = null;
                  return false;
                } else {
        ...
        stop: function (G) {
          if (arguments.length) {
            G =
              G instanceof v.Scroll.Full
                ? G
                : (j(G) && j(G).jFetch("scroll")) || null;
            if (!G) {
              return;
            }
    ...
    j(document).jAddEvent("domready", function () {
      p = p();
      o = v
        .$new("div", { class: "msc-tmp-hdn-holder" })
        .jAppendTo(document.body);
      ...
      v.defined(window.MagicScrollMobileExtraOptions) ||
        (window.MagicScrollMobileExtraOptions = {});
      var G =
        window.MagicScrollMobileExtraOptions.beforeInit ||
